function  trackMap = trackmateEdges_JWB(filePath, featureList)
...
%% Import the XPath classes.
    ...
    disp(['Note that the track names Track_XX no longer match'...
        ' the names at the top of the columns in TrackScheme'...
        newline 'They are now Track_TRACK_ID'])
        %see the commented trackName line below
    for i = 1 : nTracks
        ...
        trackName       = strcat( 'Track_', char( trackNode.getAttribute( TRACK_ID_ATTRIBUTE ) ) );
